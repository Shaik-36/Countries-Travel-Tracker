...
VALUES (1, '+123456789', '123 London Street');
...
VALUES ('Sam', 'Derak'), ('Barry', 'powderblue');
...
--- Add new column or make column properties change ---
...
DELETE FROM visited_countries WHERE user_id = 5;

DELETE FROM visited_countries WHERE user_id = 5 AND country_code = 'FI';
